> Historical design record, not current installation or upgrade instructions.
> See the [current guide](../../README.md). Pairing-based Visit links and manual
> deletion of empty devices described below are obsolete.
